...
<script type="text/javascript" src="//cdn.callbackhunter.com/cbh.js?hunter_code=4db4426f740472808dd4ffeab29b609b" charset="UTF-8"></script>
...
?>
    ...
    <a href="#feedback" popup_href="/feedback/" id="feedback-btn" class="ajaxform"></a>
<?php
    ...
    <header>
        ...
        <div class="center-col">
            ...
            <div class="info-block">
                <a href="#feedback" popup_href="/feedback/" id="feedback-btn2" class="ajaxform"
...
<? if ($APPLICATION->GetCurDir() != "/" || ERROR_404 == "Y"): ?>
    ...
    <? } else { ?>
        ...
        <h1<?= $header_class ? " class='{$header_class}'" : "" ?>><? $APPLICATION->ShowTitle(false); ?></h1>
    <? } ?>
<? endif ?>