 ...
 */
$LIB_EXISTS = include($_SERVER['DOCUMENT_ROOT'] .'/smsimple-api/lib/xmlrpc.inc');
...
//        echo '<pre>';
//        print_r(new xmlrpcmsg('call', array(new xmlrpcval($method), php_xmlrpc_encode($params))));
//        echo '</pre>';
