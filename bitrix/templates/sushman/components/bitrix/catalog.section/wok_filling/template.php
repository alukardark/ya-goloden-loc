...
if (!empty($arResult['ITEMS'])) {
    ...
    <div id="wok-filling">
        ...
        <ul class="bx_catalog_list_home items"><?
            foreach ($arResult['ITEMS'] as $key => $arItem) {
                ...
                ?>
                <li class="bx_catalog_item_container wok-filling" id="<? echo $strMainID; ?>">
                ...
                <a target="_blank" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"
                   ...
                   id="<? echo $arItemIDs['PICT']; ?>" title="<? echo $strTitle; ?>"><span
                    ...
                    <span class="title valigned t" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"
                          title="<? echo $arItem['NAME']; ?>"><span><? echo $arItem['NAME']; ?></span></span></a>
                <?
	...
	<span class="price bx_price" id="<? echo $arItemIDs['PRICE']; ?>"><?
        ...
        if (!empty($arItem['MIN_PRICE'])) {
            echo $priceShowed = str_replace("руб.", "<span class='ico-rub'></span>",
