    ...
    <div id="j_menu">
        <ul class="bx_catalog_list_home items">
            ...
            foreach ($arResult['ITEMS'] as $key => $arItem)
            {
                ...
                if($curSectionId != $lastSectionId){
                    $curSection = CIblockSection::GetByID($curSectionId);
                    if ($arSect = $curSection->Getnext()){
                ?><li class="sectionTitle"><h2><?= $arSect['NAME']; ?></h2></li><?
                    }
                }
            ...
            <?
             if ($arItem['OFFERS_PROPS_DISPLAY'])
                                    ...
                                    $arJSParams = array(
                                'PRODUCT_TYPE' => 1,//$arItem['CATALOG_TYPE'],
                                ...
                                'BASKET' => array(
                                    ...
                                    'EMPTY_PROPS' => true,//$emptyProductProperties
                                ),
                                'VISUAL' => array(
                                    'ID' => $arItemIDs['ID'],
                ...
                if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS']))
                {
                    if ($arItem['CAN_BUY'])
                    {
                                        ...
                                        <a id="<? echo $arItemIDs['BUY_LINK']; ?>_addto" class="addto bx_bt_button bx_medium" href="javascript:void(0)" rel="nofollow" data-product-id="<?=$arItem["ID"]?>" data-id="<?=$orig_id?>">
                                            <? } else { ?>
                                        <a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="buy bx_bt_button bx_medium" href="javascript:void(0)" rel="nofollow">
                                            <? } ?>
                                            Купить</a><?
                    }
                    else
