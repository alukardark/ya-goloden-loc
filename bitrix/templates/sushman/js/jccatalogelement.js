...
window.JCCatalogElement.prototype.ChangeInfo = function()
{
	...
	if (-1 < index)
	{
		...
		{
			BX.adjust(this.obPrice.price, {html: this.offers[index].PRICE.PRINT_DISCOUNT_VALUE.replace("руб.","<span class='ico-rub'></span>")});
			if (this.offers[index].PRICE.DISCOUNT_VALUE !== this.offers[index].PRICE.VALUE)
			{
				if (this.config.showOldPrice)
				{
					...
					{
						BX.adjust(this.obPrice.full, {style: {display: ''}, html: this.offers[index].PRICE.PRINT_VALUE.replace("руб.","<span class='ico-rub'></span>")});
					}
...
window.JCCatalogElement.prototype.SendToBasket = function()
{
        if (!this.canBuy)
	{
        ...
        $("span",this.obBuyBtn).addClass("loader");
...
window.JCCatalogElement.prototype.BasketResult = function(arResult)
{
	...
	{
            $("span",this.obBuyBtn).removeClass("loader");
